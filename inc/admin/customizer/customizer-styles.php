...
function courtyard_custom_style() {
	...
	if( $custom_primary_color != '#00bcd4' ) {
		// Primary Color
		$custom .= "a, a:visited, .pt-logo .site-title a, .pt-menu li:hover > a, .pt-menu li.current-menu-item a, .pt-home-navbar li.current-menu-item a, .pt-home-navbar .pt-menu li li:hover > a, .pt-service-col .fa, .pt-service-col h3:hover a, .pt-room-cont h3:hover a, .pt-recent-posts-col:hover h3 a, pt-services-more a:hover, .pt-rooms-more a:hover, .pt-read-more a:hover, .pt-read-more a:hover, .pt-services-more .pt-arrow-left:hover, .pt-services-more .pt-arrow-right:hover, .pt-rooms-more .pt-arrow-left:hover, .pt-rooms-more .pt-arrow-right:hover, .pt-room-cont:hover h3 a, .pt-rooms-more a:hover, pt-recent-posts-col:hover h3 a, .pt-read-more a:hover, .entry-meta .posted-on a, .entry-meta .byline a, .entry-footer .edit-link a, .comments-area .comment-list a, .comment-respond .logged-in-as a, .pt-breadcrumbs .trail-items .trail-item a, .pt-footer-wrapper li a:hover, footer.site-footer a:hover, .pt-content-wrap .entry-title a:hover, .pt-content-wrap span.posted-on a:hover, .pt-content-wrap span.byline a:hover, .pt-content-wrap span.cat-links a:hover, .pt-content-wrap span.tags-links a:hover, .post-navigation .nav-links a:hover, .pt-breadcrumbs-items li a:hover, #secondary li a:hover, .pt-menu-sm:hover, .page-template-template-services .pt-service-icon { color: " . esc_attr( $theme_primary_color ) . "}"."\n";
